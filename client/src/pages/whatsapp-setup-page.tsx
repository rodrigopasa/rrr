...
import { MessageCircle, Users, Smartphone, Link as LinkIcon } from "lucide-react";
    ...
    <MainLayout>
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
          <div>
            <h2 className="text-2xl font-bold heading-gradient">Configuração do WhatsApp</h2>
          ...
          {status?.isAuthenticated && (
            <div className="flex gap-2">
              <Button 
                asChild
                className="btn-primary flex items-center gap-2 btn-hover-effect"
              >
        ...
        <Tabs defaultValue="setup" className="w-full" onValueChange={setActiveTab}>
          ...
          <TabsContent value="stats">
            {status?.isAuthenticated ? (
                  ...
                  <CardContent>
                    {isLoadingContacts ? (
                      ...
                      <div className="flex items-end justify-between">
                        ...
                        <Button variant="ghost" size="sm" asChild className="text-orange-600">
              ...
              <div className="flex flex-col items-center justify-center p-8 bg-gradient-to-br from-blue-50 to-orange-50 rounded-lg border border-blue-100">
                <div className="bg-white p-4 rounded-full mb-4 shadow-md">
                  <LinkIcon className="h-10 w-10 text-gray-400" />
                </div>
                <h3 className="text-xl font-medium heading-gradient mb-2">Conecte o WhatsApp Primeiro</h3>
                <p className="text-gray-600 text-center max-w-md mb-4">
                  Para acessar as estatísticas, é necessário conectar seu WhatsApp primeiro.
                </p>
                <Button onClick={() => setActiveTab("setup")} className="btn-primary">
